...
class UNet_Nested(nn.Module):
    ...
    def __init__(self, in_channels=3, n_class=6, feature_scale=2, is_deconv=True, is_batchnorm=True, is_ds=True):
        ...
        self.final_1 = nn.Conv2d(filters[0], n_class, 1)
        self.final_2 = nn.Conv2d(filters[0], n_class, 1)
        self.final_3 = nn.Conv2d(filters[0], n_class, 1)
        self.final_4 = nn.Conv2d(filters[0], n_class, 1)
...
if __name__ == '__main__':
    ...
    net = UNet_Nested(n_class=num_classes).cuda()
